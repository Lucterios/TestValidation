...
// --- Last modification: Date 11 February 2010 22:11:18 By  ---
...
$actions[19] = new Param_Action("Erreurs en Base", "TableTest_APAS_ErrorInTable", 0);
$actions[20] = new Param_Action("Lister des TableTest", "TableTest_APAS_List", 0);
$actions[21] = new Param_Action("Rechercher un TableTest", "TableTest_APAS_Search", 0);
$actions[22] = new Param_Action("Truc", "TableTest_APAS_Truc", 0);
$actions[23] = new Param_Action("Valider une erreur", "TableTest_APAS_ValiderErreur", 0);
$actions[24] = new Param_Action("Ajouter", "TableTest_APAS_ajouter", 0);
$actions[25] = new Param_Action("Editer", "TableTest_APAS_editer", 0);
$actions[26] = new Param_Action("Ecran des erreurs", "TableTest_APAS_errorManager", 0);
$actions[27] = new Param_Action("Supprimer", "TableTest_APAS_suppr", 0);
$actions[28] = new Param_Action("Valider", "TableTest_APAS_valider", 0);
$actions[29] = new Param_Action("verouxDlg", "TableTest_APAS_verouxDlg", 0);
$actions[30] = new Param_Action("verouxSimple", "TableTest_APAS_verouxSimple", 0);
$actions[31] = new Param_Action("veroux", "TableTest_APAS_veroux", 0);
$actions[32] = new Param_Action("Action de validation des composants", "TestComposants", 0);
$actions[33] = new Param_Action("Valider un TrucTable", "TrucTable_APAS_AddModifyAct", 0);
$actions[34] = new Param_Action("Ajouter/Modifier un TrucTable", "TrucTable_APAS_AddModify", 0);
$actions[35] = new Param_Action("Supprimer un TrucTable", "TrucTable_APAS_Del", 0);
