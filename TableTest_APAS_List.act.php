...
// --- Last modification: Date 23 November 2008 12:18:01 By  ---
...
//@DESC@Lister des TableTest


//@LOCK:0

function TableTest_APAS_List($Params)
{
$self=new DBObj_TestValidation_TableTest();
try {
$xfer_result=&new Xfer_Container_Custom("TestValidation","TableTest_APAS_List",$Params);
$xfer_result->Caption="Lister des TableTest";
//@CODE_ACTION@
$lbl=new  Xfer_Comp_LabelForm("titre");
$lbl->setLocation(0,0,2);
$xfer_result->addComponent($lbl);
	$lbl->setValue("{[center]}{[bold]}Lister des TableTest{[/bold]}{[/center]}");
	$self->find();
