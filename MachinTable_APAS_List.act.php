...
//@DESC@Lister des MachinTable


//@LOCK:0

function MachinTable_APAS_List($Params)
{
$self=new DBObj_TestValidation_MachinTable();
try {
$xfer_result=&new Xfer_Container_Custom("TestValidation","MachinTable_APAS_List",$Params);
$xfer_result->Caption="Lister des MachinTable";
//@CODE_ACTION@
$lbl=new  Xfer_Comp_LabelForm("titre");
$lbl->setLocation(0,0,2);
$xfer_result->addComponent($lbl);
	$lbl->setValue("{[center]}{[bold]}Lister des MachinTable{[/bold]}{[/center]}");
	$self->find();
$grid = $self->getGrid("MachinTable");
