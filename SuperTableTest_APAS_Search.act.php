...
// --- Last modification: Date 02 November 2011 4:32:50 By  ---
...
//@DESC@Rechercher un SuperTableTest
//@PARAM@ 


//@LOCK:0

function SuperTableTest_APAS_Search($Params)
{
$self=new DBObj_TestValidation_SuperTableTest();
try {
$xfer_result=&new Xfer_Container_Custom("TestValidation","SuperTableTest_APAS_Search",$Params);
$xfer_result->Caption="Rechercher un SuperTableTest";
//@CODE_ACTION@
