...
//@DESC@Autre test de merge entre 1 objet mere et 1 fille
//@PARAM@ 

function TestValidation_mergeMereFilleBis(&$test)
{
//@CODE_ACTION@
global $connect;
$connect->execute("DELETE FROM TestValidation_SuperTableTest",true);
