...
//@DESC@Lister des SuperContact


//@LOCK:0

function SuperContact_APAS_List($Params)
{
$self=new DBObj_TestValidation_SuperContact();
try {
$xfer_result=&new Xfer_Container_Custom("TestValidation","SuperContact_APAS_List",$Params);
$xfer_result->Caption="Lister des SuperContact";
//@CODE_ACTION@
$lbl=new  Xfer_Comp_LabelForm("titre");
$lbl->setLocation(0,0,2);
$xfer_result->addComponent($lbl);
	$lbl->setValue("{[center]}{[bold]}Lister des SuperContact{[/bold]}{[/center]}");
	$self->find();
