...
//@DESC@Fiche d'un SuperContact
//@INDEX:SuperContact


//@LOCK:2

function SuperContact_APAS_Fiche($Params)
{
...
$self->lockRecord("SuperContact_APAS_Fiche");
try {
$xfer_result=&new Xfer_Container_Custom("TestValidation","SuperContact_APAS_Fiche",$Params);
$xfer_result->Caption="Fiche d'un SuperContact";
$xfer_result->m_context['ORIGINE']="SuperContact_APAS_Fiche";
...
//@CODE_ACTION@
	...
	$self->unlockRecord("SuperContact_APAS_Fiche");
	throw $e;
}
return $xfer_result;
}
